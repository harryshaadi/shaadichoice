<?php 
	...
	$formVldParm = "text:fname:First Name~text:mname:Middle name~text:lname:Last name~numericPhone:contact_no:Mobile Number~dropDown:religion_code:Religion Name~dropDown:maritial_status:Marital Status";	
?>
