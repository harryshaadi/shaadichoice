					...
					<div class="col-sm-9 panel-body">
						<div class="inbox" style="height: 575px; overflow-y: scroll;">
										...
										<div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
											<div class="dropdown pull-right">
											  ...
											  <ul class="dropdown-menu drop_down pull-right" id="drop">
												...
												<li><a href="javascript:void(0)" onClick='return msgread("<?=$_GET['cu_id'];?>");'>Delete Conversation</a></li>
							...
							<?php
								...
								$whereClausenm = '';
								$whereClausenm.= '((msg_from ="'.$_SESSION['userDetail']['profile_code'].'" AND msg_to ="'.$_GET['cu_id'].'") OR (msg_to ="'.$_SESSION['userDetail']['profile_code'].'" AND msg_from ="'.$_GET['cu_id'].'"))'.$wq;
								$stpm = '';
								$perPage = '';
