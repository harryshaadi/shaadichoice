    ...
    <div class="message-body">
        <div class="message-left">
            <ul>
                <?php
					$profileCode = $_SESSION['userDetail']['profile_code'];
					$selectedCols = "m.request_to as to_id, p.login_status as login_status, CONCAT(p.fname,' ',p.mname,' ',p.lname) as username, i.image";
					$tbls = "`tbl_profiles` as `p`, `tbl_match_request` as `m`, `tbl_profile_images` as `i` ";
					$where ='';
					$where.=" p.profile_code='".$profileCode."' AND p.profile_code=i.profile_code AND m.request_from=p.profile_code AND m.request_status='A' AND p.profile_status='A' ";
                   ...
                   // exit;
					...
					foreach($ChatUSersList as $row){
						...
						$image = getUserPic($row['image']);
						echo "<a href='message.php?id={$row['to_id']}'><li><img src='{$image}'> {$row['username']}</li></a>";
					}
                ?>
            </ul>
        </div>
			...
			<div class="send-message">
                ...
                <div class="form-group">
					...
					<div id="emotion" style="display:;">
						<input type="image" src="images/alien1.png" alt="alien" title="alien" value=":aln" onclick="moveValue(this.value)"> 
						<input type="image" src="images/annoyed.png" alt="annoyed" title="thinking" value=":thk" onclick="moveValue(this.value)"> 
						<input type="image" src="images/angel.png" alt="angel" title="angel" value=":ang" onclick="moveValue(this.value)"> 
						
						<input type="image" src="images/zzz.png" alt="zzz" title="sleep" value=":slp" onclick="moveValue(this.value)"> 
						<input type="image" src="images/blanco.png" alt="blanco" title="blank face" value=":blnk" onclick="moveValue(this.value)"> 
						<input type="image" src="images/zip_it.png" alt="zip_it" title="Keep Secret" value=":zip" onclick="moveValue(this.value)">
						
						<input type="image" src="images/boring.png" alt="boring" title="boring" value=":bor" onclick="moveValue(this.value)"> 
						<input type="image" src="images/brb.png" alt="brb" title="be right back" value=":brb" onclick="moveValue(this.value)"> 
						<input type="image" src="images/busy.png" alt="busy" title="busy" value=":bsy" onclick="moveValue(this.value)">
						
						<input type="image" src="images/cellphone.png" alt="cellphone" title="On Call" value=":cell" onclick="moveValue(this.value)"> 
						<input type="image" src="images/clock.png" alt="clock" title="Time Please"  value=":tp" onclick="moveValue(this.value)"> 
						<input type="image" src="images/cool.png" alt="cool" title="cool"  value=":cool" onclick="moveValue(this.value)"> 
						
						<input type="image" src="images/crazy.png" alt="crazy" title="crazy" value=":czy" onclick="moveValue(this.value)"> 
						<input type="image" src="images/cry.png" alt="cry" title="cry" value=":cry" onclick="moveValue(this.value)"> 
						<input type="image" src="images/devil.png" alt="devil" title="devil" value=":dvl" onclick="moveValue(this.value)"> 
						
						<input type="image" src="images/blush.png" alt="blush" title="blush" value=":blush" onclick="moveValue(this.value)"> 
						<input type="image" src="images/dnd.png" alt="dnd" title="Stop" value=":stop" onclick="moveValue(this.value)"> 
						<input type="image" src="images/flower.png" alt="flower" title="flower" value=":flwr" onclick="moveValue(this.value)"> 							  
						
						<input type="image" src="images/heart.png" alt="heart" title="heart" value=":heart" onclick="moveValue(this.value)"> 
						<input type="image" src="images/geek.png" alt="geek" title="geek" value=":geek" onclick="moveValue(this.value)"> 
						<input type="image" src="images/gift.png" alt="gift" title="gift" value=":gift" onclick="moveValue(this.value)"> 							  
						
						<input type="image" src="images/ill.png" alt="ill" title="ill" value=":ill" onclick="moveValue(this.value)"> 
						<input type="image" src="images/in_love.png" alt="in_love" title="in love" value=":love" onclick="moveValue(this.value)"> 
						<input type="image" src="images/text_file.png" alt="text_file" title="file" value=":file" onclick="moveValue(this.value)"> 							  
						
						<input type="image" src="images/kissy.png" alt="kissy" title="kissy" value=":kiss" onclick="moveValue(this.value)"> 
						<input type="image" src="images/laugh.png" alt="laugh" title="laugh" value=":laugh" onclick="moveValue(this.value)"> 
						<input type="image" src="images/mail.png" alt="mail" title="mail" value=":mail" onclick="moveValue(this.value)"> 							  
						
						<input type="image" src="images/music2.png" alt="music2" title="music2" value=":music" onclick="moveValue(this.value)"> 
						<input type="image" src="images/not_guilty.png" alt="not_guilty" title="Whistle" value=":whst" onclick="moveValue(this.value)"> 
						<input type="image" src="images/please.png" alt="please" title="please" value=":please" onclick="moveValue(this.value)">							  
						
						<input type="image" src="images/info.png" alt="info" title="info" value='<img src="images/info.png" alt="info" title="info">' onclick="moveValue(this.value)"> 
						<input type="image" src="images/sad.png" alt="sad" title="sad" value='<img src="images/sad.png" alt="sad" title="sad" value=":sad">' onclick="moveValue(this.value)"> 
						<input type="image" src="images/silly.png" alt="silly" title="silly" value='<img src="images/silly.png" alt="silly" title="silly">' onclick="moveValue(this.value)">						  
						
						<input type="image" src="images/oh.png" alt="oh" title="Laugh Out Loud" value='<img src="images/oh.png" alt="Laugh Out Loud" title="Laugh Out Loud">' onclick="moveValue(this.value)"> 
						<input type="image" src="images/speechless.png" alt="speechless" title="speechless" value='<img src="images/speechless.png" alt="speechless" title="speechless">' onclick="moveValue(this.value)"> 
						<input type="image" src="images/surprised.png" alt="surprised" title="surprised" value='<img src="images/tease.png" alt="surprised" title="surprised">' onclick="moveValue(this.value)"> 
						
						<input type="image" src="images/tease.png" alt="tease" title="tease" value='<img src="images/tease.png" alt="tease" title="tease">' onclick="moveValue(this.value)"> 
						<input type="image" src="images/wink.png" alt="wink" title="wink" value='<img src="images/wink.png" alt="wink" title="wink">' onclick="moveValue(this.value)"> 
						<input type="image" src="images/xd.png" alt="Big Grin" title="Big Grin" value='<img src="images/xd.png" alt="Big Grin" title="Big Grin">' onclick="moveValue(this.value)">  
                    </div>
...
<div class="msg_box" id="msg_box_1" style="right:260px;">
	<div class="msg_head">
...
<script>
	...
	function register_popup(id, name)
	{
		...
		*/
		...
		element = element + '<div class="msg_wrap"><div class="msg_body">'+data+'<div class="msg_insert"></div></div>';
		element = element + '<div class="msg_footer"><form><textarea style=" resize: none;" class="form-control" rows="1"></textarea></form></div></div>';
		element = element + '</div>';
