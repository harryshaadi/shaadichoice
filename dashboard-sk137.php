...
<script>
	...
	/*
		...
		*/
		...
		element = element + '<div class="msg_footer"><div class="iconsd">click</div>'+myicons+'<form><textarea style=" resize: none; width:200px;" class="form-control" rows="1"></textarea><button type="button" class="btn btn-danger"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button></form></div></div>';
		element = element + '</div>';
