...
<title><?=ucwords(str_replace("-"," ",$_REQUEST['code']))?> - Shaadichoice.com</title>

<meta name="Keywords" content="Shaadichoice.com official blog, latest updated membership discount offers new  and corrporate news.
" />

<meta name="Description" content="Official Blog Shaadichoice.com
"/>




<link rel="canonical" href="http://www.shaadichoice.com/blog.php">  
...
<?php $reviewDetails = $db->getRecord(0, array('*'), 'tbl_reviews'); 
        ...
        <div class="collapse navbar-collapse" id="collapse">
        	<div class="nav1">
                <ul class="nav navbar-nav">
                    <li><a href="<?=USER_PATH?>howitworks.php">How it Works</a></li>
