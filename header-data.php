...
$actual_link = $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
 ...
 $pageInfoArr = $db->getRecord(0,array('*'),'tbl_manage_page',array('page_name' => $link[1]));
?>
<!doctype html>
<html>
<head>
...
<title> <?=$pageInfoArr[0]['page_title']?></title>

<meta name="Keywords" content=" <?=$pageInfoArr[0]['meta_keyword']?>" />

<meta name="Description" content=" <?=$pageInfoArr[0]['meta_description']?>"/>
